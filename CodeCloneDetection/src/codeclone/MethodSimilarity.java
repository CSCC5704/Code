...
public class MethodSimilarity {
	...
	public double tokenListDis(TokenList tList1, TokenList tList2) {
	...
	public void simDetector(MethodList mList) {
		for(int index1 = 0; index1 < mList.size() - 1; index1++) {
			for(int index2 = index1 + 1; index2 < mList.size(); index2++) {
				...
				simTokenType = tokenListDis(tList1, tList2);
				...
				simTokenKeyword = tokenListDis(tList1, tList2);
				...
				simTokenOtherStr = tokenListDis(tList1, tList2);
				...
				simTokenMarker = tokenListDis(tList1, tList2);
				...
				simTokenOperator = tokenListDis(tList1, tList2);
				...
				simTokenOtherChar = tokenListDis(tList1, tList2);
